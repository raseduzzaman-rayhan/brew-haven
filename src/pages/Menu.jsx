      ...
      <div className="relative z-10 container mx-auto px-4 md:px-8 py-12 text-white">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-white/70 max-w-xl mx-auto">
            Explore our wide selection of hand-crafted beverages and fresh-baked treats.
          </p>
        </div>
        ...
        <div className="flex flex-col md:flex-row gap-6 mb-12 items-center justify-between">
          <div className="relative w-full md:w-96">
            ...
            <input
              ...
              className="input input-bordered w-full pl-12 rounded-full bg-white/10 text-white placeholder:text-white/50 border-white/20 focus:outline-none"
              value={search}
          ...
          <div className="flex flex-wrap gap-2 justify-center">
            {categories.map((cat, index) => (
              <button
                ...
                className={`btn btn-sm rounded-full px-6 font-bold transition-all ${category === cat
                    ? 'btn-primary'
